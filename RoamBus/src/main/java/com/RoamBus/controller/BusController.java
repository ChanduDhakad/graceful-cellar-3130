...
public class BusController {
	...
	@PostMapping("/bus")
	public ResponseEntity<Bus> registerBus(@Valid @RequestBody Bus bus, @RequestParam("key") String key)
	...
	@PutMapping("/bus")
	public ResponseEntity<Bus> updateBus(@Valid @RequestBody Bus bus, @RequestParam("key") String key)
			throws BusException, AdminException, LoginException {
	...
	public ResponseEntity<Bus> deleteBus(@PathVariable Integer id, @RequestParam("key") String key)
			throws BusException, AdminException, LoginException {
		Bus b = bService.deleteBus(id, key);
		return new ResponseEntity<Bus>(b, HttpStatus.OK);
	}
	@GetMapping("/bus/{id}")
	public ResponseEntity<Bus> viewBus(@PathVariable Integer id, @RequestParam("key") String key)
			throws BusException, LoginException {
		Bus b = bService.viewBus(id, key);
		return new ResponseEntity<Bus>(b, HttpStatus.OK);
	}

	@GetMapping("/buses/{busType}")
	public ResponseEntity<List<Bus>> viewBusesByType(@PathVariable String busType, @RequestParam("key") String key)
			throws BusException, LoginException {
