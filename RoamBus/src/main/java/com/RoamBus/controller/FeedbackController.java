...
public class FeedbackController {
	...
	public  ResponseEntity<Feedback>  addFeedback(@Valid @RequestBody Feedback fs,@RequestParam String key) throws LoginException, FeedbackException {
	...
	public  ResponseEntity<Feedback>  updateFeedback(@Valid @RequestBody Feedback fs,@RequestParam String key) throws LoginException, FeedbackException {
     	...
     	public  ResponseEntity<Feedback>  getFeedback(@Valid @PathVariable int id,@RequestParam String key) throws LoginException, FeedbackException {
     	...
     	public  ResponseEntity<List<Feedback>>  getAllFeedback(@Valid @RequestParam String key) throws LoginException, FeedbackException, AdminException {
