...
public class AdminController {
	...
	@PostMapping("/admin")
	public ResponseEntity<Admin> registerUser(@Valid @RequestBody Admin user) throws com.RoamBus.exception.AdminException {
	...
	@GetMapping("/admin/{u}")
	public ResponseEntity<Admin> getUserDetailsHandler(@PathVariable ("u") String username) throws  com.RoamBus.exception.AdminException  {
	...
	@PutMapping("/admin")
	public ResponseEntity<Admin> updateUserHandler(@Valid @RequestParam (required = false) String key, @RequestBody Admin user) throws com.RoamBus.exception.AdminException, LoginException  {
